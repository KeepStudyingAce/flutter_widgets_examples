...
class BubbleTabBarPage extends StatefulWidget {
  @override
  _BubbleTabBarPageState createState() => _BubbleTabBarPageState();
}

class _BubbleTabBarPageState extends State<BubbleTabBarPage> {
