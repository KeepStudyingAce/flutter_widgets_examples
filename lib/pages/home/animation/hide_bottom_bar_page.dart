...
class HideBottomBarPage extends StatefulWidget {
  @override
  _HideBottomBarPageState createState() => _HideBottomBarPageState();
}

class _HideBottomBarPageState extends State<HideBottomBarPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(
        title: 'Immersive BottomNavigationBar',
      ),
      body: _buildListView(),
  ...
  Widget _buildBottomNavigationBar(BuildContext context) {
    return AnimatedBuilder(
      ...
      child: BottomNavigationBar(
        ...
        unselectedItemColor: CommonColors.subTextColor,
        items: [
